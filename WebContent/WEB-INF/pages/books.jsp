...
<!-- 放在WEB-INF下的文件不能通过直接URL访问 -->
	...
	<center>
		...
		<c:if test="${!empty sessionScope.ShoppingCart }">
			你的购物车中有${sessionScope.ShoppingCart.bookNumber }本书，<a href="bookServlet?method=forwardPage&page=cart&pageNo=${bookpage.pageNo }">查看购物车</a> 
		</c:if>
