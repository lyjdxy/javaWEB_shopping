package com.crazy.bookstore.servlet;
...
import com.crazy.bookstore.service.AccountService;
import com.crazy.bookstore.service.UserService;
...
import com.crazy.bookstore.web.BookStoreWebUtils;
...
public class BookServlet extends HttpServlet {
	...
	protected void addToCart(HttpServletRequest request, HttpServletResponse response)
		...
		if(id > 0){
			...
			//3.调用BookService的addToCart()方法把商品放到购物车
